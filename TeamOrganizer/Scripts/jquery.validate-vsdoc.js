...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Proszę wpisać prawidłowy adres mailowy.",
		...
		maxlength: $.validator.format("Proszę nie podawać więcej niż {0} znaków."),
		minlength: $.validator.format("Proszę podać co najmniej {0} znaków."),
